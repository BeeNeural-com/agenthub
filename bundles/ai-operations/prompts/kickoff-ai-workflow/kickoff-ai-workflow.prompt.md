---
name: Kickoff AI Workflow
description: >-
  Structured kickoff for ai operations work: classify request,
  select skills and agents, and produce an initial plan.
tags: [ai-operations, kickoff]
---

You are kicking off a **ai operations** thread.
