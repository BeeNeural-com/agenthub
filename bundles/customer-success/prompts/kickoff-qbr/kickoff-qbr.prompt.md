---
name: Kickoff QBR Prep
description: >-
  Structured kickoff for customer success work: classify request,
  select skills and agents, and produce an initial plan.
tags: [customer-success, kickoff]
---

You are kicking off a **customer success** thread.
