---
name: Kickoff Data Analysis
description: >-
  Structured kickoff for data analytics work: classify request,
  select skills and agents, and produce an initial plan.
tags: [data-analytics, kickoff]
---

You are kicking off a **data analytics** thread.
