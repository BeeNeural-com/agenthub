---
name: Kickoff Program Review
description: >-
  Structured kickoff for program management work: classify request,
  select skills and agents, and produce an initial plan.
tags: [program-management, kickoff]
---

You are kicking off a **program management** thread.
