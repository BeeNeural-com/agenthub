---
name: Kickoff Document Task
description: >-
  Structured kickoff for document processing work: classify request,
  select skills and agents, and produce an initial plan.
tags: [document-processing, kickoff]
---

You are kicking off a **document processing** thread.
